...
func (r ResearchStudy) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ResearchStudy) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ResearchStudy"
	return v2.Marshal(OtherResearchStudy(r))
}
...
func UnmarshalResearchStudy(b []byte) (ResearchStudy, error) {
	...
	if err := v2.Unmarshal(b, &researchStudy); err != nil {
