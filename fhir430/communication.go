...
func (r Communication) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Communication) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Communication"
	return v2.Marshal(OtherCommunication(r))
}

// UnmarshalCommunication unmarshals a Communication.
func UnmarshalCommunication(b []byte) (Communication, error) {
	var communication Communication
	if err := v2.Unmarshal(b, &communication); err != nil {
