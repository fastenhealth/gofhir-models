...
func (r CommunicationRequest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r CommunicationRequest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "CommunicationRequest"
	return v2.Marshal(OtherCommunicationRequest(r))
}
...
func UnmarshalCommunicationRequest(b []byte) (CommunicationRequest, error) {
	...
	if err := v2.Unmarshal(b, &communicationRequest); err != nil {
