...
func (r MedicationKnowledge) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicationKnowledge) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicationKnowledge"
	return v2.Marshal(OtherMedicationKnowledge(r))
}
...
func UnmarshalMedicationKnowledge(b []byte) (MedicationKnowledge, error) {
	...
	if err := v2.Unmarshal(b, &medicationKnowledge); err != nil {
