...
func (r MeasureReport) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MeasureReport) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MeasureReport"
	return v2.Marshal(OtherMeasureReport(r))
}
...
func UnmarshalMeasureReport(b []byte) (MeasureReport, error) {
	...
	if err := v2.Unmarshal(b, &measureReport); err != nil {
