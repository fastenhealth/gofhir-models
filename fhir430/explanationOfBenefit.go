...
func (r ExplanationOfBenefit) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ExplanationOfBenefit) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ExplanationOfBenefit"
	return v2.Marshal(OtherExplanationOfBenefit(r))
}
...
func UnmarshalExplanationOfBenefit(b []byte) (ExplanationOfBenefit, error) {
	...
	if err := v2.Unmarshal(b, &explanationOfBenefit); err != nil {
