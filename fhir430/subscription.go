...
func (r Subscription) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Subscription) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Subscription"
	return v2.Marshal(OtherSubscription(r))
}

// UnmarshalSubscription unmarshals a Subscription.
func UnmarshalSubscription(b []byte) (Subscription, error) {
	var subscription Subscription
	if err := v2.Unmarshal(b, &subscription); err != nil {
