...
func (r Encounter) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Encounter) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Encounter"
	return v2.Marshal(OtherEncounter(r))
}

// UnmarshalEncounter unmarshals a Encounter.
func UnmarshalEncounter(b []byte) (Encounter, error) {
	var encounter Encounter
	if err := v2.Unmarshal(b, &encounter); err != nil {
