...
func (r MedicationStatement) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicationStatement) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicationStatement"
	return v2.Marshal(OtherMedicationStatement(r))
}
...
func UnmarshalMedicationStatement(b []byte) (MedicationStatement, error) {
	...
	if err := v2.Unmarshal(b, &medicationStatement); err != nil {
