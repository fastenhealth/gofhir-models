...
func (r ClaimResponse) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ClaimResponse) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ClaimResponse"
	return v2.Marshal(OtherClaimResponse(r))
}
...
func UnmarshalClaimResponse(b []byte) (ClaimResponse, error) {
	...
	if err := v2.Unmarshal(b, &claimResponse); err != nil {
