...
func (r SubstancePolymer) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r SubstancePolymer) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "SubstancePolymer"
	return v2.Marshal(OtherSubstancePolymer(r))
}
...
func UnmarshalSubstancePolymer(b []byte) (SubstancePolymer, error) {
	...
	if err := v2.Unmarshal(b, &substancePolymer); err != nil {
