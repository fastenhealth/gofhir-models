...
func (r AdverseEvent) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r AdverseEvent) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "AdverseEvent"
	return v2.Marshal(OtherAdverseEvent(r))
}
...
func UnmarshalAdverseEvent(b []byte) (AdverseEvent, error) {
	...
	if err := v2.Unmarshal(b, &adverseEvent); err != nil {
