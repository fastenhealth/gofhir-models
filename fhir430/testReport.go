...
func (r TestReport) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r TestReport) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "TestReport"
	return v2.Marshal(OtherTestReport(r))
}

// UnmarshalTestReport unmarshals a TestReport.
func UnmarshalTestReport(b []byte) (TestReport, error) {
	var testReport TestReport
	if err := v2.Unmarshal(b, &testReport); err != nil {
