...
func (r SubstanceSpecification) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r SubstanceSpecification) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "SubstanceSpecification"
	return v2.Marshal(OtherSubstanceSpecification(r))
}
...
func UnmarshalSubstanceSpecification(b []byte) (SubstanceSpecification, error) {
	...
	if err := v2.Unmarshal(b, &substanceSpecification); err != nil {
