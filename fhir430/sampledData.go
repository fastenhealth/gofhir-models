...
type SampledData struct {
	...
	Period     jsontext.Value         `bson:"period" json:"period"`
	Factor     *jsontext.Value        `bson:"factor,omitempty" json:"factor,omitempty"`
	LowerLimit *jsontext.Value        `bson:"lowerLimit,omitempty" json:"lowerLimit,omitempty"`
	UpperLimit *jsontext.Value        `bson:"upperLimit,omitempty" json:"upperLimit,omitempty"`
