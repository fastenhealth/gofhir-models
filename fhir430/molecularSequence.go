...
type MolecularSequenceQuality struct {
	...
	TruthTP           *jsontext.Value              `bson:"truthTP,omitempty" json:"truthTP,omitempty"`
	QueryTP           *jsontext.Value              `bson:"queryTP,omitempty" json:"queryTP,omitempty"`
	TruthFN           *jsontext.Value              `bson:"truthFN,omitempty" json:"truthFN,omitempty"`
	QueryFP           *jsontext.Value              `bson:"queryFP,omitempty" json:"queryFP,omitempty"`
	GtFP              *jsontext.Value              `bson:"gtFP,omitempty" json:"gtFP,omitempty"`
	Precision         *jsontext.Value              `bson:"precision,omitempty" json:"precision,omitempty"`
	Recall            *jsontext.Value              `bson:"recall,omitempty" json:"recall,omitempty"`
	FScore            *jsontext.Value              `bson:"fScore,omitempty" json:"fScore,omitempty"`
...
type MolecularSequenceQualityRoc struct {
	...
	Precision         []jsontext.Value       `bson:"precision,omitempty" json:"precision,omitempty"`
	Sensitivity       []jsontext.Value       `bson:"sensitivity,omitempty" json:"sensitivity,omitempty"`
	FMeasure          []jsontext.Value       `bson:"fMeasure,omitempty" json:"fMeasure,omitempty"`
}
...
func (r MolecularSequence) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MolecularSequence) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MolecularSequence"
	return v2.Marshal(OtherMolecularSequence(r))
}
...
func UnmarshalMolecularSequence(b []byte) (MolecularSequence, error) {
	...
	if err := v2.Unmarshal(b, &molecularSequence); err != nil {
