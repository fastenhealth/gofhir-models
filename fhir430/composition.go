...
func (r Composition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Composition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Composition"
	return v2.Marshal(OtherComposition(r))
}

// UnmarshalComposition unmarshals a Composition.
func UnmarshalComposition(b []byte) (Composition, error) {
	var composition Composition
	if err := v2.Unmarshal(b, &composition); err != nil {
