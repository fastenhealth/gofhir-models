...
func (r ExampleScenario) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ExampleScenario) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ExampleScenario"
	return v2.Marshal(OtherExampleScenario(r))
}
...
func UnmarshalExampleScenario(b []byte) (ExampleScenario, error) {
	...
	if err := v2.Unmarshal(b, &exampleScenario); err != nil {
