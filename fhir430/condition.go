...
func (r Condition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Condition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Condition"
	return v2.Marshal(OtherCondition(r))
}

// UnmarshalCondition unmarshals a Condition.
func UnmarshalCondition(b []byte) (Condition, error) {
	var condition Condition
	if err := v2.Unmarshal(b, &condition); err != nil {
