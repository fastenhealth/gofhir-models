...
func (r Observation) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Observation) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Observation"
	return v2.Marshal(OtherObservation(r))
}

// UnmarshalObservation unmarshals a Observation.
func UnmarshalObservation(b []byte) (Observation, error) {
	var observation Observation
	if err := v2.Unmarshal(b, &observation); err != nil {
