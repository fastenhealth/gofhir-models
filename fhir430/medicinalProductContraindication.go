...
func (r *MedicinalProductContraindication) MarshalJSON() ([]byte, error) {
	r.raw.SetRawValue("resourceType", json.RawMessage("\"MedicinalProductContraindication\""))
	return r.raw.ToJSON(r)
}

// UnmarshalJSON unmarshals the given MedicinalProductContraindication from JSON.
