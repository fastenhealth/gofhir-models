...
func (r Procedure) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Procedure) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Procedure"
	return v2.Marshal(OtherProcedure(r))
}

// UnmarshalProcedure unmarshals a Procedure.
func UnmarshalProcedure(b []byte) (Procedure, error) {
	var procedure Procedure
	if err := v2.Unmarshal(b, &procedure); err != nil {
