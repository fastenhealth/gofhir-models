...
func (r MedicinalProductPackaged) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProductPackaged) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProductPackaged"
	return v2.Marshal(OtherMedicinalProductPackaged(r))
}
...
func UnmarshalMedicinalProductPackaged(b []byte) (MedicinalProductPackaged, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProductPackaged); err != nil {
