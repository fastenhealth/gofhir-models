...
func (r ChargeItemDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ChargeItemDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ChargeItemDefinition"
	return v2.Marshal(OtherChargeItemDefinition(r))
}
...
func UnmarshalChargeItemDefinition(b []byte) (ChargeItemDefinition, error) {
	...
	if err := v2.Unmarshal(b, &chargeItemDefinition); err != nil {
