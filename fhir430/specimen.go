...
func (r Specimen) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Specimen) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Specimen"
	return v2.Marshal(OtherSpecimen(r))
}

// UnmarshalSpecimen unmarshals a Specimen.
func UnmarshalSpecimen(b []byte) (Specimen, error) {
	var specimen Specimen
	if err := v2.Unmarshal(b, &specimen); err != nil {
		return specimen, err
	}
	return specimen, nil
}
