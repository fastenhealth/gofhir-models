...
type ChargeItem struct {
	...
	FactorOverride         *jsontext.Value        `bson:"factorOverride,omitempty" json:"factorOverride,omitempty"`
...
func (r ChargeItem) ContainedResources() []jsontext.Value {
	return r.Contained
}
