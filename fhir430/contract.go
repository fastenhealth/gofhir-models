...
type ContractTermOfferAnswer struct {
	...
	ValueDecimal      jsontext.Value         `bson:"valueDecimal" json:"valueDecimal"`
...
type ContractTermAssetValuedItem struct {
	...
	Factor                *jsontext.Value        `bson:"factor,omitempty" json:"factor,omitempty"`
	Points                *jsontext.Value        `bson:"points,omitempty" json:"points,omitempty"`
...
func (r Contract) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Contract) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Contract"
	return v2.Marshal(OtherContract(r))
}

// UnmarshalContract unmarshals a Contract.
func UnmarshalContract(b []byte) (Contract, error) {
	var contract Contract
	if err := v2.Unmarshal(b, &contract); err != nil {
		return contract, err
	}
	return contract, nil
}
