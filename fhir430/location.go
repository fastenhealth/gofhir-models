...
type LocationPosition struct {
	...
	Extension         []Extension            `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension            `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Longitude         jsontext.Value         `bson:"longitude" json:"longitude"`
	Latitude          jsontext.Value         `bson:"latitude" json:"latitude"`
	Altitude          *jsontext.Value        `bson:"altitude,omitempty" json:"altitude,omitempty"`
}
...
func (r Location) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Location) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Location"
	return v2.Marshal(OtherLocation(r))
}

// UnmarshalLocation unmarshals a Location.
func UnmarshalLocation(b []byte) (Location, error) {
	var location Location
	if err := v2.Unmarshal(b, &location); err != nil {
		return location, err
	}
	return location, nil
}
