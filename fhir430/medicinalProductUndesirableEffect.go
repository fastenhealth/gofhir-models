...
func (r MedicinalProductUndesirableEffect) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProductUndesirableEffect) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProductUndesirableEffect"
	return v2.Marshal(OtherMedicinalProductUndesirableEffect(r))
}
...
func UnmarshalMedicinalProductUndesirableEffect(b []byte) (MedicinalProductUndesirableEffect, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProductUndesirableEffect); err != nil {
