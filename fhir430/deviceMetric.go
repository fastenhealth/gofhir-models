...
func (r DeviceMetric) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r DeviceMetric) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "DeviceMetric"
	return v2.Marshal(OtherDeviceMetric(r))
}
...
func UnmarshalDeviceMetric(b []byte) (DeviceMetric, error) {
	...
	if err := v2.Unmarshal(b, &deviceMetric); err != nil {
