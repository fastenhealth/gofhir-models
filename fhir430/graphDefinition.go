...
func (r GraphDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r GraphDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "GraphDefinition"
	return v2.Marshal(OtherGraphDefinition(r))
}
...
func UnmarshalGraphDefinition(b []byte) (GraphDefinition, error) {
	...
	if err := v2.Unmarshal(b, &graphDefinition); err != nil {
