...
func (r HealthcareService) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r HealthcareService) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "HealthcareService"
	return v2.Marshal(OtherHealthcareService(r))
}
...
func UnmarshalHealthcareService(b []byte) (HealthcareService, error) {
	...
	if err := v2.Unmarshal(b, &healthcareService); err != nil {
