...
func (r ImmunizationRecommendation) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ImmunizationRecommendation) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ImmunizationRecommendation"
	return v2.Marshal(OtherImmunizationRecommendation(r))
}
...
func UnmarshalImmunizationRecommendation(b []byte) (ImmunizationRecommendation, error) {
	...
	if err := v2.Unmarshal(b, &immunizationRecommendation); err != nil {
