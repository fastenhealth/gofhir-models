...
func (r MedicationDispense) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicationDispense) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicationDispense"
	return v2.Marshal(OtherMedicationDispense(r))
}
...
func UnmarshalMedicationDispense(b []byte) (MedicationDispense, error) {
	...
	if err := v2.Unmarshal(b, &medicationDispense); err != nil {
