...
func (r MedicinalProductManufactured) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProductManufactured) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProductManufactured"
	return v2.Marshal(OtherMedicinalProductManufactured(r))
}
...
func UnmarshalMedicinalProductManufactured(b []byte) (MedicinalProductManufactured, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProductManufactured); err != nil {
