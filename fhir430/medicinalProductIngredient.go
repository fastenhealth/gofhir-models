...
func (r MedicinalProductIngredient) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProductIngredient) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProductIngredient"
	return v2.Marshal(OtherMedicinalProductIngredient(r))
}
...
func UnmarshalMedicinalProductIngredient(b []byte) (MedicinalProductIngredient, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProductIngredient); err != nil {
