...
func (r CapabilityStatement) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r CapabilityStatement) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "CapabilityStatement"
	return v2.Marshal(OtherCapabilityStatement(r))
}
...
func UnmarshalCapabilityStatement(b []byte) (CapabilityStatement, error) {
	...
	if err := v2.Unmarshal(b, &capabilityStatement); err != nil {
