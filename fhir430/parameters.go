...
func (r Parameters) ContainedResources() []jsontext.Value {
	return nil
}
...
func (r Parameters) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Parameters"
	return v2.Marshal(OtherParameters(r))
}

// UnmarshalParameters unmarshals a Parameters.
func UnmarshalParameters(b []byte) (Parameters, error) {
	var parameters Parameters
	if err := v2.Unmarshal(b, &parameters); err != nil {
