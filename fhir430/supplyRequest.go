...
func (r SupplyRequest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r SupplyRequest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "SupplyRequest"
	return v2.Marshal(OtherSupplyRequest(r))
}
...
func UnmarshalSupplyRequest(b []byte) (SupplyRequest, error) {
	...
	if err := v2.Unmarshal(b, &supplyRequest); err != nil {
