...
func (r MessageDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MessageDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MessageDefinition"
	return v2.Marshal(OtherMessageDefinition(r))
}
...
func UnmarshalMessageDefinition(b []byte) (MessageDefinition, error) {
	...
	if err := v2.Unmarshal(b, &messageDefinition); err != nil {
