...
func (r ImplementationGuide) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ImplementationGuide) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ImplementationGuide"
	return v2.Marshal(OtherImplementationGuide(r))
}
...
func UnmarshalImplementationGuide(b []byte) (ImplementationGuide, error) {
	...
	if err := v2.Unmarshal(b, &implementationGuide); err != nil {
