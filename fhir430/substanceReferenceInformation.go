...
func (r *SubstanceReferenceInformation) MarshalJSON() ([]byte, error) {
	r.raw.SetRawValue("resourceType", json.RawMessage("\"SubstanceReferenceInformation\""))
	return r.raw.ToJSON(r)
}

// UnmarshalJSON unmarshals the given SubstanceReferenceInformation from JSON.
