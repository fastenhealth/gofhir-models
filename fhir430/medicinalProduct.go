...
func (r MedicinalProduct) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProduct) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProduct"
	return v2.Marshal(OtherMedicinalProduct(r))
}
...
func UnmarshalMedicinalProduct(b []byte) (MedicinalProduct, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProduct); err != nil {
