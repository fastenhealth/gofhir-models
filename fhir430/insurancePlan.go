...
func (r InsurancePlan) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r InsurancePlan) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "InsurancePlan"
	return v2.Marshal(OtherInsurancePlan(r))
}
...
func UnmarshalInsurancePlan(b []byte) (InsurancePlan, error) {
	...
	if err := v2.Unmarshal(b, &insurancePlan); err != nil {
