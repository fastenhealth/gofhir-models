...
func (r OperationDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r OperationDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "OperationDefinition"
	return v2.Marshal(OtherOperationDefinition(r))
}
...
func UnmarshalOperationDefinition(b []byte) (OperationDefinition, error) {
	...
	if err := v2.Unmarshal(b, &operationDefinition); err != nil {
