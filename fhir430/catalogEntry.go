...
func (r CatalogEntry) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r CatalogEntry) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "CatalogEntry"
	return v2.Marshal(OtherCatalogEntry(r))
}
...
func UnmarshalCatalogEntry(b []byte) (CatalogEntry, error) {
	...
	if err := v2.Unmarshal(b, &catalogEntry); err != nil {
