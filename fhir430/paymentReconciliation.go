...
func (r PaymentReconciliation) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r PaymentReconciliation) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "PaymentReconciliation"
	return v2.Marshal(OtherPaymentReconciliation(r))
}
...
func UnmarshalPaymentReconciliation(b []byte) (PaymentReconciliation, error) {
	...
	if err := v2.Unmarshal(b, &paymentReconciliation); err != nil {
