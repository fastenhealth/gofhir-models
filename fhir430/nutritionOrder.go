...
func (r NutritionOrder) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r NutritionOrder) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "NutritionOrder"
	return v2.Marshal(OtherNutritionOrder(r))
}
...
func UnmarshalNutritionOrder(b []byte) (NutritionOrder, error) {
	...
	if err := v2.Unmarshal(b, &nutritionOrder); err != nil {
