...
func (r Immunization) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Immunization) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Immunization"
	return v2.Marshal(OtherImmunization(r))
}
...
func UnmarshalImmunization(b []byte) (Immunization, error) {
	...
	if err := v2.Unmarshal(b, &immunization); err != nil {
