...
func (r PlanDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r PlanDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "PlanDefinition"
	return v2.Marshal(OtherPlanDefinition(r))
}
...
func UnmarshalPlanDefinition(b []byte) (PlanDefinition, error) {
	...
	if err := v2.Unmarshal(b, &planDefinition); err != nil {
