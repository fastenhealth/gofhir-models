...
type EffectEvidenceSynthesisEffectEstimate struct {
	...
	VariantState      *CodeableConcept                                         `bson:"variantState,omitempty" json:"variantState,omitempty"`
	Value             *jsontext.Value                                          `bson:"value,omitempty" json:"value,omitempty"`
...
type EffectEvidenceSynthesisEffectEstimatePrecisionEstimate struct {
	...
	ModifierExtension []Extension            `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Type              *CodeableConcept       `bson:"type,omitempty" json:"type,omitempty"`
	Level             *jsontext.Value        `bson:"level,omitempty" json:"level,omitempty"`
	From              *jsontext.Value        `bson:"from,omitempty" json:"from,omitempty"`
	To                *jsontext.Value        `bson:"to,omitempty" json:"to,omitempty"`
}
...
func (r EffectEvidenceSynthesis) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r EffectEvidenceSynthesis) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "EffectEvidenceSynthesis"
	return v2.Marshal(OtherEffectEvidenceSynthesis(r))
}
...
func UnmarshalEffectEvidenceSynthesis(b []byte) (EffectEvidenceSynthesis, error) {
	...
	if err := v2.Unmarshal(b, &effectEvidenceSynthesis); err != nil {
