...
type QuestionnaireResponseItemAnswer struct {
	...
	ValueDecimal      *jsontext.Value             `bson:"valueDecimal,omitempty" json:"valueDecimal,omitempty"`
...
func (r QuestionnaireResponse) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r QuestionnaireResponse) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "QuestionnaireResponse"
	return v2.Marshal(OtherQuestionnaireResponse(r))
}
...
func UnmarshalQuestionnaireResponse(b []byte) (QuestionnaireResponse, error) {
	...
	if err := v2.Unmarshal(b, &questionnaireResponse); err != nil {
