...
func (r Coverage) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Coverage) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Coverage"
	return v2.Marshal(OtherCoverage(r))
}

// UnmarshalCoverage unmarshals a Coverage.
func UnmarshalCoverage(b []byte) (Coverage, error) {
	var coverage Coverage
	if err := v2.Unmarshal(b, &coverage); err != nil {
		return coverage, err
	}
	return coverage, nil
}
