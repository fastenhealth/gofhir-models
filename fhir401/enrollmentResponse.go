...
func (r EnrollmentResponse) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r EnrollmentResponse) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "EnrollmentResponse"
	return v2.Marshal(OtherEnrollmentResponse(r))
}
...
func UnmarshalEnrollmentResponse(b []byte) (EnrollmentResponse, error) {
	...
	if err := v2.Unmarshal(b, &enrollmentResponse); err != nil {
