...
func (r MedicinalProductInteraction) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProductInteraction) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProductInteraction"
	return v2.Marshal(OtherMedicinalProductInteraction(r))
}
...
func UnmarshalMedicinalProductInteraction(b []byte) (MedicinalProductInteraction, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProductInteraction); err != nil {
