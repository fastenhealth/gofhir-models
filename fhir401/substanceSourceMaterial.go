...
func (r SubstanceSourceMaterial) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r SubstanceSourceMaterial) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "SubstanceSourceMaterial"
	return v2.Marshal(OtherSubstanceSourceMaterial(r))
}
...
func UnmarshalSubstanceSourceMaterial(b []byte) (SubstanceSourceMaterial, error) {
	...
	if err := v2.Unmarshal(b, &substanceSourceMaterial); err != nil {
