...
func (r MedicinalProductPharmaceutical) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProductPharmaceutical) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProductPharmaceutical"
	return v2.Marshal(OtherMedicinalProductPharmaceutical(r))
}
...
func UnmarshalMedicinalProductPharmaceutical(b []byte) (MedicinalProductPharmaceutical, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProductPharmaceutical); err != nil {
