...
func (r *MedicinalProductPharmaceutical) MarshalJSON() ([]byte, error) {
	r.raw.SetRawValue("resourceType", json.RawMessage("\"MedicinalProductPharmaceutical\""))
	return r.raw.ToJSON(r)
}

// UnmarshalJSON unmarshals the given MedicinalProductPharmaceutical from JSON.
