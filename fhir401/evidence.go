...
func (r Evidence) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Evidence) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Evidence"
	return v2.Marshal(OtherEvidence(r))
}

// UnmarshalEvidence unmarshals a Evidence.
func UnmarshalEvidence(b []byte) (Evidence, error) {
	var evidence Evidence
	if err := v2.Unmarshal(b, &evidence); err != nil {
		return evidence, err
	}
	return evidence, nil
}
