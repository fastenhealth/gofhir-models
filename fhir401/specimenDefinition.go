...
func (r SpecimenDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r SpecimenDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "SpecimenDefinition"
	return v2.Marshal(OtherSpecimenDefinition(r))
}
...
func UnmarshalSpecimenDefinition(b []byte) (SpecimenDefinition, error) {
	...
	if err := v2.Unmarshal(b, &specimenDefinition); err != nil {
