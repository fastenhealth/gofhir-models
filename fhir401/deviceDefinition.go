...
func (r DeviceDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r DeviceDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "DeviceDefinition"
	return v2.Marshal(OtherDeviceDefinition(r))
}
...
func UnmarshalDeviceDefinition(b []byte) (DeviceDefinition, error) {
	...
	if err := v2.Unmarshal(b, &deviceDefinition); err != nil {
