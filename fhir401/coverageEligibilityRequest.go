...
func (r CoverageEligibilityRequest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r CoverageEligibilityRequest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "CoverageEligibilityRequest"
	return v2.Marshal(OtherCoverageEligibilityRequest(r))
}
...
func UnmarshalCoverageEligibilityRequest(b []byte) (CoverageEligibilityRequest, error) {
	...
	if err := v2.Unmarshal(b, &coverageEligibilityRequest); err != nil {
