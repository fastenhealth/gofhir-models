...
func (r ActivityDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ActivityDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ActivityDefinition"
	return v2.Marshal(OtherActivityDefinition(r))
}
...
func UnmarshalActivityDefinition(b []byte) (ActivityDefinition, error) {
	...
	if err := v2.Unmarshal(b, &activityDefinition); err != nil {
