...
func (r DocumentManifest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r DocumentManifest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "DocumentManifest"
	return v2.Marshal(OtherDocumentManifest(r))
}
...
func UnmarshalDocumentManifest(b []byte) (DocumentManifest, error) {
	...
	if err := v2.Unmarshal(b, &documentManifest); err != nil {
