...
func (r DomainResource) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r DomainResource) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "DomainResource"
	return v2.Marshal(OtherDomainResource(r))
}
...
func UnmarshalDomainResource(b []byte) (DomainResource, error) {
	...
	if err := v2.Unmarshal(b, &domainResource); err != nil {
