...
func (r SubstanceNucleicAcid) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r SubstanceNucleicAcid) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "SubstanceNucleicAcid"
	return v2.Marshal(OtherSubstanceNucleicAcid(r))
}
...
func UnmarshalSubstanceNucleicAcid(b []byte) (SubstanceNucleicAcid, error) {
	...
	if err := v2.Unmarshal(b, &substanceNucleicAcid); err != nil {
