...
func (r ClinicalImpression) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ClinicalImpression) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ClinicalImpression"
	return v2.Marshal(OtherClinicalImpression(r))
}
...
func UnmarshalClinicalImpression(b []byte) (ClinicalImpression, error) {
	...
	if err := v2.Unmarshal(b, &clinicalImpression); err != nil {
