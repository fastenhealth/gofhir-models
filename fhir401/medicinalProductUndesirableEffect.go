...
import (
	"encoding/json"
	jsonobj "github.com/fastenhealth/gofhir-models/fhir401/utils/jsonobj"
)
...
func (r *MedicinalProductUndesirableEffect) MarshalJSON() ([]byte, error) {
	r.raw.SetRawValue("resourceType", json.RawMessage("\"MedicinalProductUndesirableEffect\""))
	return r.raw.ToJSON(r)
}

// UnmarshalJSON unmarshals the given MedicinalProductUndesirableEffect from JSON.
