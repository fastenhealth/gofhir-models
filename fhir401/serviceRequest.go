...
func (r ServiceRequest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ServiceRequest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ServiceRequest"
	return v2.Marshal(OtherServiceRequest(r))
}

// UnmarshalServiceRequest unmarshals a ServiceRequest.
func UnmarshalServiceRequest(b []byte) (ServiceRequest, error) {
	var serviceRequest ServiceRequest
	if err := v2.Unmarshal(b, &serviceRequest); err != nil {
