...
func (r VerificationResult) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r VerificationResult) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "VerificationResult"
	return v2.Marshal(OtherVerificationResult(r))
}
...
func UnmarshalVerificationResult(b []byte) (VerificationResult, error) {
	...
	if err := v2.Unmarshal(b, &verificationResult); err != nil {
