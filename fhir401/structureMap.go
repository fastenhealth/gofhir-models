...
type StructureMapGroupRuleSource struct {
	...
	DefaultValueDecimal             *jsontext.Value             `bson:"defaultValueDecimal,omitempty" json:"defaultValueDecimal,omitempty"`
...
func (r StructureMap) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r StructureMap) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "StructureMap"
	return v2.Marshal(OtherStructureMap(r))
}
...
func UnmarshalStructureMap(b []byte) (StructureMap, error) {
	...
	if err := v2.Unmarshal(b, &structureMap); err != nil {
