...
func (r MedicationAdministration) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicationAdministration) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicationAdministration"
	return v2.Marshal(OtherMedicationAdministration(r))
}
...
func UnmarshalMedicationAdministration(b []byte) (MedicationAdministration, error) {
	...
	if err := v2.Unmarshal(b, &medicationAdministration); err != nil {
