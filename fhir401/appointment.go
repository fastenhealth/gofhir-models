...
func (r Appointment) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Appointment) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Appointment"
	return v2.Marshal(OtherAppointment(r))
}

// UnmarshalAppointment unmarshals a Appointment.
func UnmarshalAppointment(b []byte) (Appointment, error) {
	var appointment Appointment
	if err := v2.Unmarshal(b, &appointment); err != nil {
