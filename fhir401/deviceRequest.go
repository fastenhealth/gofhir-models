...
func (r DeviceRequest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r DeviceRequest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "DeviceRequest"
	return v2.Marshal(OtherDeviceRequest(r))
}

// UnmarshalDeviceRequest unmarshals a DeviceRequest.
func UnmarshalDeviceRequest(b []byte) (DeviceRequest, error) {
	var deviceRequest DeviceRequest
	if err := v2.Unmarshal(b, &deviceRequest); err != nil {
