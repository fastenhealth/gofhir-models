...
func (r EnrollmentRequest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r EnrollmentRequest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "EnrollmentRequest"
	return v2.Marshal(OtherEnrollmentRequest(r))
}
...
func UnmarshalEnrollmentRequest(b []byte) (EnrollmentRequest, error) {
	...
	if err := v2.Unmarshal(b, &enrollmentRequest); err != nil {
