...
func (r MedicationRequest) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicationRequest) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicationRequest"
	return v2.Marshal(OtherMedicationRequest(r))
}
...
func UnmarshalMedicationRequest(b []byte) (MedicationRequest, error) {
	...
	if err := v2.Unmarshal(b, &medicationRequest); err != nil {
