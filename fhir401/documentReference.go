...
func (r DocumentReference) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r DocumentReference) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "DocumentReference"
	return v2.Marshal(OtherDocumentReference(r))
}
...
func UnmarshalDocumentReference(b []byte) (DocumentReference, error) {
	...
	if err := v2.Unmarshal(b, &documentReference); err != nil {
