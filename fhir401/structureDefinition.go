...
func (r StructureDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r StructureDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "StructureDefinition"
	return v2.Marshal(OtherStructureDefinition(r))
}
...
func UnmarshalStructureDefinition(b []byte) (StructureDefinition, error) {
	...
	if err := v2.Unmarshal(b, &structureDefinition); err != nil {
