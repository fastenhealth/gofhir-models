...
type BundleEntry struct {
	...
	Resource          jsontext.Value         `bson:"resource,omitempty" json:"resource,omitempty"`
...
type BundleEntrySearch struct {
	...
	Score             *jsontext.Value        `bson:"score,omitempty" json:"score,omitempty"`
}
...
type BundleEntryResponse struct {
	...
	Outcome           jsontext.Value         `bson:"outcome,omitempty" json:"outcome,omitempty"`
}
...
func (r Bundle) ContainedResources() []jsontext.Value {
	return nil
}
...
func (r Bundle) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Bundle"
	return v2.Marshal(OtherBundle(r))
}

// UnmarshalBundle unmarshals a Bundle.
func UnmarshalBundle(b []byte) (Bundle, error) {
	var bundle Bundle
	if err := v2.Unmarshal(b, &bundle); err != nil {
		return bundle, err
	}
	return bundle, nil
}
