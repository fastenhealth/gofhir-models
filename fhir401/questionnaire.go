...
type QuestionnaireItemEnableWhen struct {
	...
	AnswerDecimal     jsontext.Value            `bson:"answerDecimal" json:"answerDecimal"`
...
func (r Questionnaire) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Questionnaire) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Questionnaire"
	return v2.Marshal(OtherQuestionnaire(r))
}

// UnmarshalQuestionnaire unmarshals a Questionnaire.
func UnmarshalQuestionnaire(b []byte) (Questionnaire, error) {
	var questionnaire Questionnaire
	if err := v2.Unmarshal(b, &questionnaire); err != nil {
