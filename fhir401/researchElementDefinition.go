...
func (r ResearchElementDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ResearchElementDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ResearchElementDefinition"
	return v2.Marshal(OtherResearchElementDefinition(r))
}
...
func UnmarshalResearchElementDefinition(b []byte) (ResearchElementDefinition, error) {
	...
	if err := v2.Unmarshal(b, &researchElementDefinition); err != nil {
