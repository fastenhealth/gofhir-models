...
func (r DiagnosticReport) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r DiagnosticReport) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "DiagnosticReport"
	return v2.Marshal(OtherDiagnosticReport(r))
}
...
func UnmarshalDiagnosticReport(b []byte) (DiagnosticReport, error) {
	...
	if err := v2.Unmarshal(b, &diagnosticReport); err != nil {
