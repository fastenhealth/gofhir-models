...
func (r RequestGroup) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r RequestGroup) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "RequestGroup"
	return v2.Marshal(OtherRequestGroup(r))
}
...
func UnmarshalRequestGroup(b []byte) (RequestGroup, error) {
	...
	if err := v2.Unmarshal(b, &requestGroup); err != nil {
