...
func (r ImagingStudy) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ImagingStudy) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ImagingStudy"
	return v2.Marshal(OtherImagingStudy(r))
}
...
func UnmarshalImagingStudy(b []byte) (ImagingStudy, error) {
	...
	if err := v2.Unmarshal(b, &imagingStudy); err != nil {
