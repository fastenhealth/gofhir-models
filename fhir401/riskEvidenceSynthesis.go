...
func (r RiskEvidenceSynthesis) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r RiskEvidenceSynthesis) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "RiskEvidenceSynthesis"
	return v2.Marshal(OtherRiskEvidenceSynthesis(r))
}
...
func UnmarshalRiskEvidenceSynthesis(b []byte) (RiskEvidenceSynthesis, error) {
	...
	if err := v2.Unmarshal(b, &riskEvidenceSynthesis); err != nil {
