...
func (r MedicinalProductContraindication) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r MedicinalProductContraindication) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "MedicinalProductContraindication"
	return v2.Marshal(OtherMedicinalProductContraindication(r))
}
...
func UnmarshalMedicinalProductContraindication(b []byte) (MedicinalProductContraindication, error) {
	...
	if err := v2.Unmarshal(b, &medicinalProductContraindication); err != nil {
