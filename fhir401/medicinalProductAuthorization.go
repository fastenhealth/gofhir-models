...
func (r *MedicinalProductAuthorization) MarshalJSON() ([]byte, error) {
	r.raw.SetRawValue("resourceType", json.RawMessage("\"MedicinalProductAuthorization\""))
	return r.raw.ToJSON(r)
}

// UnmarshalJSON unmarshals the given MedicinalProductAuthorization from JSON.
