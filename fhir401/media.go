...
type Media struct {
	...
	Duration          *jsontext.Value        `bson:"duration,omitempty" json:"duration,omitempty"`
...
func (r Media) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r Media) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "Media"
	return v2.Marshal(OtherMedia(r))
}

// UnmarshalMedia unmarshals a Media.
func UnmarshalMedia(b []byte) (Media, error) {
	var media Media
	if err := v2.Unmarshal(b, &media); err != nil {
		return media, err
	}
	return media, nil
}
