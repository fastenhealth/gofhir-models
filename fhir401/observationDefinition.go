...
type ObservationDefinitionQuantitativeDetails struct {
	...
	ConversionFactor  *jsontext.Value        `bson:"conversionFactor,omitempty" json:"conversionFactor,omitempty"`
...
func (r ObservationDefinition) ContainedResources() []jsontext.Value {
	return r.Contained
}
...
func (r ObservationDefinition) MarshalJSON() ([]byte, error) {
	...
	r.Unknown["resourceType"] = "ObservationDefinition"
	return v2.Marshal(OtherObservationDefinition(r))
}
...
func UnmarshalObservationDefinition(b []byte) (ObservationDefinition, error) {
	...
	if err := v2.Unmarshal(b, &observationDefinition); err != nil {
